package com.ntt.crfactory.web.rest;

import com.ntt.crfactory.ApiApp;
...
public class WorkloadResourceIT {
    ...
    private static final String DEFAULT_APPLICALTION = "AAAAAAAAAA";
    private static final String UPDATED_APPLICALTION = "BBBBBBBBBB";
    ...
    public static Workload createEntity() {
        Workload workload = new Workload()
            ...
            .applicaltion(DEFAULT_APPLICALTION)
    ...
    public static Workload createUpdatedEntity() {
        Workload workload = new Workload()
            ...
            .applicaltion(UPDATED_APPLICALTION)
    ...
    public void createWorkload() throws Exception {
        ...
        assertThat(testWorkload.getApplicaltion()).isEqualTo(DEFAULT_APPLICALTION);
    ...
    @Test
    public void checkMovegroupIsRequired() throws Exception {
        int databaseSizeBeforeTest = workloadRepository.findAll().size();
        // set the field null
        workload.setMovegroup(null);
    ...
    @Test
    public void checkApplicaltionIsRequired() throws Exception {
        int databaseSizeBeforeTest = workloadRepository.findAll().size();
        // set the field null
        workload.setApplicaltion(null);
    ...
    public void getAllWorkloads() throws Exception {
        ...
        restWorkloadMockMvc.perform(get("/api/workloads?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].applicaltion").value(hasItem(DEFAULT_APPLICALTION)))
    ...
    public void getWorkload() throws Exception {
        ...
        restWorkloadMockMvc.perform(get("/api/workloads/{id}", workload.getId()))
            ...
            .andExpect(jsonPath("$.applicaltion").value(DEFAULT_APPLICALTION))
    ...
    public void updateWorkload() throws Exception {
        ...
        assertThat(testWorkload.getApplicaltion()).isEqualTo(UPDATED_APPLICALTION);
