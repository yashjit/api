package com.ntt.crfactory.domain;
...
public class Workload implements Serializable {
    ...
    public String getApplicaltion() {
        return applicaltion;
    }

    public Workload applicaltion(String applicaltion) {
        this.applicaltion = applicaltion;
        return this;
    }

    public void setApplicaltion(String applicaltion) {
        this.applicaltion = applicaltion;
    }
    ...
    public Workload waves(Set<Wave> waves) {
        this.waves = waves;
        return this;
    }

    public Workload addWave(Wave wave) {
        this.waves.add(wave);
        wave.getWorkloads().add(this);
        return this;
    }

    public Workload removeWave(Wave wave) {
        this.waves.remove(wave);
        wave.getWorkloads().remove(this);
        return this;
    }
