...
import com.ntt.crfactory.service.BlueprintService;
...
/**
 * REST controller for managing {@link com.ntt.crfactory.domain.Blueprint}.
 */
@RestController
@RequestMapping("/api")
public class BlueprintResource {
    ...
    private static final String ENTITY_NAME = "apiBlueprint";
