...
import com.ntt.crfactory.service.FieldMasterService;
...
/**
 * REST controller for managing {@link com.ntt.crfactory.domain.FieldMaster}.
 */
@RestController
@RequestMapping("/api")
public class FieldMasterResource {
    ...
    private static final String ENTITY_NAME = "apiFieldMaster";
